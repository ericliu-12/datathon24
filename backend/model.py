...
# print(chat_model.invoke("How to use Databricks?").content)

keyword_prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
           """Given {prompt}, extract the project name if there is any, and the type of network it is (system design or something else),
and the key features of the project through examples if provided or specific keywords. I need your output to only be JSON and to follow this example strictly: 
